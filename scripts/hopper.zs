...
recipes.remove(<thaumcraft:essentia_output>);
recipes.remove(<thaumcraft:pattern_crafter>);
...
recipes.addShaped(<thaumcraft:pattern_crafter>, [[<ic2:te:88>, <thaumcraft:mechanism_simple>], [<thaumcraft:mechanism_simple>, <buildcraftcore:engine:2>]]);
recipes.addShaped(<thaumcraft:essentia_output>, [[<ore:plateBrass>, <buildcraftcore:engine:2>, <ore:plateBrass>], [<ore:plateIron>, <thaumcraft:metal_alchemical>, <ore:plateIron>]]);
